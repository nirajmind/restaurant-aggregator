...
public class AnalyticsService {
    ...
    private final Queue<AnalyticsProducer.RestaurantViewEvent> eventBuffer = new ConcurrentLinkedQueue<>();
    ...
    public void recordView(Long restaurantId, String username) {
        eventBuffer.offer(new AnalyticsProducer.RestaurantViewEvent(restaurantId, username, LocalDateTime.now()));
    }
    ...
    public void flushEvents() {
        ...
        List<AnalyticsProducer.RestaurantViewEvent> batch = new ArrayList<>();
        AnalyticsProducer.RestaurantViewEvent event;
    ...
    private void processBatch(List<AnalyticsProducer.RestaurantViewEvent> batch) {
        ...
        long uniqueRestaurants = batch.stream().map(AnalyticsProducer.RestaurantViewEvent::restaurantId).distinct().count();
